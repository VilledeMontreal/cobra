...
func (c *Command) getCompletions(args []string) (*Command, []string, ShellCompDirective, error) {
	...
	// Note that we want to perform flag completion even if finalCmd.DisableFlagParsing==true;
	// this is because it is possible that flags were configured in Cobra, even if they are not meant
	// to be fully parsed.  See the Helm plugin completion solution for an example.
